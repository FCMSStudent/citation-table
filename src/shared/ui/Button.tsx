  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background hover:bg-accent hover:text-accent-foreground hover:border-accent transition-colors",
        ...
        gradient: "bg-gradient-primary text-white hover:shadow-lg hover:scale-[1.05] active:scale-[0.98] transition-all",
        glow: "bg-primary text-primary-foreground hover:shadow-[0_0_20px_rgba(99,102,241,0.5)] hover:scale-[1.02] active:scale-[0.98] transition-all",
        animated: "bg-primary text-primary-foreground hover:shadow-xl hover:scale-[1.05] active:scale-[0.98] transition-all duration-300",
      },
      size: {
